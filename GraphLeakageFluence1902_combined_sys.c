...
void EvaluateDiodes() //Function to define relevant files and corresponging parameters.
{
	...
	If.fluence_error = If.fluence*sys_error;
	...
	Ig.fluence_error = Ig.fluence*sys_error;
	Is.push_back(Ig);
	...
	Ih.fluence_error = Ih.fluence*sys_error;
	Is.push_back(Ih);
	...
	Ii.fluence_error = Ii.fluence*sys_error;
	Is.push_back(Ii);
	...
	Ij.fluence_error = Ij.fluence*sys_error;
	Is.push_back(Ij);
...
void GraphLeakageFluence1902_combined_sys()
{	
