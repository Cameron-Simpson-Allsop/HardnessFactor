...
void EvaluateDiodes() //Function to define relevant files and corresponging parameters.
{
	...
	Ia.fluence_error = pow(pow(8.430e10/c,2.)+pow((Ia.fluence*error_c)/(c*c),2.),0.5);
	...
	Ib.fluence_error = pow(pow(9.039e10/c,2.)+pow((Ib.fluence*error_c)/(c*c),2.),0.5);
	Is.push_back(Ib);
	...
	Ic.fluence_error = pow(pow(7.500e10/c,2.)+pow((Ic.fluence*error_c)/(c*c),2.),0.5);
	Is.push_back(Ic);
	...
	Id.fluence_error = pow(pow(8.070e10/c,2.)+pow((Id.fluence*error_c)/(c*c),2.),0.5);
	Is.push_back(Id);
	...
	Ie.fluence_error = pow(pow(8.142e10/c,2.)+pow((Ie.fluence*error_c)/(c*c),2.),0.5);
	Is.push_back(Ie);
