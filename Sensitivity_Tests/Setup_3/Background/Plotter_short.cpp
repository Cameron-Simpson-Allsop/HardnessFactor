...
void Plotter_short()
{
  ...
  TLegend *leg = new TLegend(0.15,0.4,0.3y,0.5);
  leg->SetBorderSize(0);
  leg->SetFillColor(0);
  ...
  mg->Draw("AP");
  leg->Draw();
  canvas->SaveAs("BPW34F_setup3_short_background.root");
  //canvas->SaveAs("BPW34F_setup3_short_background.pdf");
  //canvas->SaveAs("BPW34F_setup3_short_background.png");
}
